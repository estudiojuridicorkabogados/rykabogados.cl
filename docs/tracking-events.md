...
**Status legend:** ✅ live · 🔜 planned in a later phase-2 pull request.
...
| Event | Status | Ads conversion | Extra labels |
| --- | --- | --- | --- |
...
| `rk_chat_lead_fail` | 🔜 | The lead was collected but the email did not send. Today this is silent in both directions. | |
