...
| On a phone, do they reach the end, where the box is? | `RK · Embudo blog`, `Lectura` tab, mobile, the `75` column — 100 is the bottom of the page, past related posts and the footer, so it undercounts who reached the box |
