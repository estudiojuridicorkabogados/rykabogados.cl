...
- **The trabajadores side is a policy risk.** Google's personalised-advertising policy lists *negative financial status* as a sensitive category, with "unemployment resources" among its examples, and for sensitive categories *your data segments* — the Analytics audiences — are not supported at all ([policy](https://support.google.com/adspolicy/answer/143465), [category](https://support.google.com/adspolicy/answer/16700443)). Dismissal claims are not named, but ads to recently dismissed workers are exactly what a reviewer could read as that category. Empresas carries no such risk. So: Observation on both existing campaigns, which reports how list members behave without changing who sees the ads; Targeting only in a separate remarketing campaign or ad group — empresas first, trabajadores after a clean week in Observation. Never Targeting on the main campaigns: it restricts serving to list members and would all but stop them.
...
- [ ] Audiences used in Ads — decided yes, 24 September 2026. Observation on the existing campaigns, Targeting only in a separate remarketing campaign — empresas first, trabajadores after the policy check; lists split by form, 24 September 2026; each list must reach 100 before it can serve. See Outstanding
...
- [x] The four split audiences (phase 4) listed in Google Ads → Audience manager → Your data segments — **seen 24 September 2026, the day they were built**, alongside the combined originals and older segments. Source Google Analytics. Expected within a day or two of 24 September 2026; both prerequisites confirmed 24 September 2026: the Analytics link's personalised advertising is Enabled, and ads personalisation is on for Chile under Admin → Data collection. Missing by then is a fault to raise with Google, not a setting
- [ ] Split audiences into Ads. **Observation** on the existing empresas and trabajadores campaigns — harmless at any size, it reports on list members without changing who sees the ads, so it can go on now. **Targeting only in a separate remarketing campaign or ad group** with its own budget and ads, once a list holds 100 or more; never on the main campaigns, where Targeting restricts serving to list members and would all but stop them. Trabajadores remarketing only after its policy status has stayed clean in Observation for a week. (Corrected 24 September 2026: an earlier line here put the empresas pair on the empresas campaign as Targeting.)
...
## Phase 8: Read the reports automatically (recurring) — going ahead, decided 24 September 2026
