...
- [ ] `Session default channel group` as the breakdown on every funnel tab. Found 24 September 2026 that none had one — the Session campaign breakdown in the recipe had never been applied. Done on `RK · Embudo trabajadores`; still to do on empresas, contacto, chatbot (both funnel tabs), cualquier contacto and blog
