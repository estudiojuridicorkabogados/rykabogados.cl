        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10">
            ...
            <div className="space-y-6">
              {/* Necessary cookies */}
              <div className="border-primary-600 border-l-4 pl-4">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <Link
              href={URLS.home()}
              className="group text-md hover:text-accent-dark items-center gap-2 font-bold text-black transition-colors duration-200"
            >
              ← Volver al inicio
            </Link>
          </div>
