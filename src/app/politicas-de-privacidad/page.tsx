          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p className="text-gray-700 mb-4">
                ...
                sobre el tratamiento que realiza <b>RK Abogados</b> respecto de
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <li>
                  La Ley N° 20.575 que establece el principio de finalidad en el
                  tratamiento de datos personales.
                </li>
                <li>
                  El Decreto Supremo N° 779/2000 del Ministerio de Justicia, que
                  aprueba el Reglamento de Bancos de Datos Personales a Cargo de
                  Organismos Públicos.
                </li>
                <li>
                  Las recomendaciones técnicas del Servicio Nacional del
                  Consumidor (SERNAC) en materia de consentimiento y uso de
                  cookies.
                </li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 mb-4">
                ...
                estricta confidencialidad y seguridad profesional.
              </p>
              <p className="text-gray-700">
                El estudio y su personal se encuentran sujetos al deber de
                secreto profesional y confidencialidad previsto en el artículo 7
                de la Ley N° 19.628, obligación que subsiste indefinidamente,
                incluso después de finalizada la relación profesional con el
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>
                  ...
                  profesión, antecedentes laborales, judiciales o patrimoniales.
                </li>
                <li>
                  <strong>Titular de los datos:</strong> la persona natural a la
                  que se refieren los datos personales.
                </li>
                <li>
                  <strong>Tratamiento:</strong> cualquier operación u
                  operaciones sobre datos personales, como su recolección,
                  registro, almacenamiento, uso, comunicación, transmisión o
                  eliminación.
                </li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
                ...
                <li>
                  Cuando contrata nuestros servicios jurídicos o solicita
                  información sobre ellos.
                </li>
                <li>
                  Cuando navega por nuestro sitio web y autoriza el uso de
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
                ...
                <li>
                  Antecedentes laborales, judiciales o patrimoniales entregados
                  voluntariamente.
                </li>
                <li>
                  Datos técnicos de navegación (dirección IP, tipo de
                  dispositivo, páginas visitadas, tiempo de sesión, etc.).
                </li>
              </ul>
              <p className="text-gray-700">
                El sitio utiliza herramientas como Google Analytics y Vercel,
            ...
            <section className="mb-12">
              ...
              <ol className="list-decimal pl-6 text-gray-700 space-y-2">
                ...
                <li>
                  Evaluar antecedentes jurídicos con el propósito de entregar
                  orientación o prestar servicios legales.
                </li>
                <li>
                  Mantener la comunicación y gestión de la relación profesional
                  con los clientes y usuarios.
                </li>
                <li>
                  Cumplir obligaciones legales o contractuales derivadas de la
                ...
                <li>
                  ...
                  <ul className="list-disc pl-6 text-gray-700 space-y-2 mt-2">
                    ...
                    <li>
                      Mejorar la calidad de los servicios ofrecidos y la
                      atención a los usuarios.
                    </li>
                    <li>
                      Diseñar y evaluar estrategias de comunicación, difusión y
                      mejora continua.
                    </li>
                  </ul>
                </li>
                <li>
                  Enviar comunicaciones legales, institucionales o informativas,
              ...
              <p className="text-gray-700 mt-4">
                ...
                recopilados, y no se transferirán a terceros sin autorización
                expresa del titular o mandato legal.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <li>
                  La ejecución o preparación de un contrato de prestación de
                  servicios jurídicos.
                </li>
                <li>
                  El cumplimiento de obligaciones legales o requerimientos de
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
                ...
                <li>
                  Cookies de preferencias o personalización: recuerdan
                  configuraciones elegidas por el usuario (por ejemplo, idioma o
                  región).
                </li>
                <li>
                  Cookies analíticas o estadísticas: permiten recopilar datos
                  agregados o anonimizados sobre el tráfico y uso del sitio, con
                  el fin de elaborar informes estadísticos o bases de datos
                  internas orientadas a la mejora del servicio.
                </li>
                <li>
                  Cookies publicitarias o de marketing: se utilizan para ofrecer
                  contenido o comunicaciones adaptadas al interés del usuario,
              ...
              <p className="text-gray-700 mb-4">
                ...
                el usuario podrá revocar su consentimiento en cualquier momento.
              </p>
              <p className="text-gray-700">
                Los datos que eventualmente se recopilen mediante cookies
                analíticas o formularios web podrán ser utilizados por RK
                Abogados de manera agregada y anonimizada para fines
                estadísticos, garantizando que no se identifique ni
                individualice a los usuarios.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <li>
                  Lo requiera una autoridad judicial o administrativa, en
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <li>
                  Solicitar rectificación de datos incorrectos o incompletos.
                </li>
                <li>
                  Solicitar eliminación o cancelación de datos cuyo
                  almacenamiento carezca de fundamento legal.
                </li>
                <li>
                  Oponerse al uso de sus datos para fines distintos a los
                  informados.
                </li>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <li>
                  ...
                  artículo 16 de la Ley N° 19.628.
                </li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                ...
                <li>
                  Elaborar estadísticas y bases de datos institucionales con
                  fines de mejora y gestión interna.
                </li>
                <li>
                  Cumplir obligaciones legales, administrativas o contables que
              ...
              <p className="text-gray-700 mt-4">
                ...
                técnicas y organizativas implementadas por RK Abogados para
                resguardar la confidencialidad y seguridad de la información.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700">
                RK Abogados podrá modificar esta Política de Privacidad para
                adaptarla a cambios normativos, tecnológicos o institucionales.
                Toda modificación será publicada oportunamente en el sitio web,
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700">
                La presente Política de Privacidad entra en vigencia desde su
                publicación en www.rkabogados.cl y será aplicable a todos los
                tratamientos de datos personales realizados por el estudio
                jurídico RK Abogados.
              </p>
            </section>
